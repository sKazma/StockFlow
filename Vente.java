...
public class Vente {
	...
	public Vente() throws IOException{
...
//		System.out.println("--- VENTE DU CLIENT: Mme/Mr "+c+" "+formater.format(date)+" ---\n"); //voir le type date
//		System.out.println("Article"+"  |  "+"référence"+"  |  "+"prix à l'unité en euros"+"  | "+"quantite");
//		System.out.println("-------------------------------------------------------------");
//	}
//	
